...
const faqDefaultData = [
  {
    ...
    content:
      'Christ Fellowship is a church in Florida with a passion to help you know God and grow in your relationships so that you can discover your purpose and impact your world. Led by Senior Pastors Todd & Julie Mullins, our mission is to impact the world with the love and message of Jesus Christ—everyone, everyday, everywhere. <a className="underline text-ocean" target="_blank" href="/about">Find out more about our church and our beliefs.</a>',
  },
  {
    title: 'Are there any expectations for visitors?',
    content: `Not at all. When we say "welcome home", we mean it! Be yourself, relax, and enjoy the service. We can't wait to see you!`,
  },
  {
...
const faqTrinityData = [
  ...
  },
  {
    ...
    content: "Yes! Parking is located on-site, and the best part—it's free!",
  },
  {
    title: 'How long are the services?',
    content:
...
export const faqHeartForHouseData = [
...

  {
    ...
    content: `Yes! You can give to Heart for the House any time throughout 2024, either as a one-time gift or you can set up a recurring gift (weekly/monthly) through December 31 until your goal is met.`,
  },
  {
    color: '#414141',
    fontStyle: 'normal',
    title: 'How do I give to Heart for the House?',
    content: `You can be a part of giving to this special offering called Heart for the House by either giving a one-time gift online AND/OR planning your giving goal for 2024 and setting up a recurring gift online through December 31 until your goal is met. You can also give in person using a giving container in service or at a giving station with the envelope available at your location.<br/><br/>
...
export const faqEspanolData = [
  ...
  },
  {
    ...
    content: `Para nada. Cuando decimos "bienvenido a casa", ¡lo decimos en serio! Sé tú mismo, relájate y disfruta del servicio. ¡Estamos emocionados por verte!`,
  },
  {
...
export const faqDefaultOtherData = {
  ...
  content: 'Someone from our team is happy to answer any of your questions!',
...
export const faqCfEverywhereData = [
  ...
  },
  {
    ...
    content: `If you are in South Florida, we hope you are getting connected to your local campus! <a href="/locations">Find a campus location near you here.</a>`,
  },
  {
  ...
  },
  {
    ...
    content: `We are excited that you are preparing to take the next step in your faith! Please email <a href="mailto:hello@christfellowship.church">hello@christfellowship.church</a> to connect with a member of our CF Everywhere Team or <a href="/events/interested-in-getting-baptized">sign up to get baptized</a> at your nearest Christ Fellowship location.`,
  },
];
